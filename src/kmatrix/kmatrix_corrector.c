...
static int r_over = 0;
static I_Known r_over_kw = {1, &r_over};
...
static keyword keywds[] = {
  ...
  KW("no_rhs_ck", IK_val, &r_over_kw, "Override rhs check")
};
static char banner[] = 
{"KMATRIX_CORRECTOR_STEP SIMULATOR 2017\n\n"};
...
int main(int argc, char **argv){
	...
	real *x_=NULL;
	real *ptr_primal = NULL, *ptr_dual = NULL;
	//real *gf= NULL;
	int *c_flag=NULL;
	char **suf_name=NULL;
...
//	  printf("The name of the suffix %s\n", suf_name[i]);
  ...
  // factorize the matrix
	pardiso_driver(Kr_strt, Kcol, Kij, K_nrows, k_space, 1, Crhs, x_);
